...
export interface Env {
  ...
  // researcher pulls account info from Solscan Pro API. Without it the
  // brief still ships but the contract-security signal is dropped.
  // Get a key from https://pro.solscan.io/.
